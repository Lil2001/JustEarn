...
import NavigationComponent from './components/NanvigationComponent';
import OrdersClientComponent from './components/Orders/OrdersClient';
import OrdersClientFavComponent from './components/Orders/OrdersClientFav';
import EditingPageComponent from './components/Orders/EditingPage';
...
function OrdersClient({ navigation }) {
  return (
    <OrdersClientComponent navigation={navigation} />
  )
}


function OrdersClientFav({ navigation }) {
  return (
    <OrdersClientFavComponent navigation={navigation} />
  )
}

function EditingPage({ navigation }) {
  return (
    <EditingPageComponent navigation={navigation} />
  )
}
    ...
    <AuthContext.Provider value={authContext}>
      ...
      <NavigationContainer>
        ...
        >
          ...
          />
          <Tab.Screen name='Navigation' component={NavigationComponent}
            options={({ route }) => ({
              tabBarButton: () => null,
              tabBarStyle: { display: 'none' }
            })}
          />
          <Tab.Screen name='OrdersClient' component={OrdersClientComponent}
            options={({ route }) => ({
              tabBarButton: () => null,
              tabBarStyle: { display: 'none' }
            })}
          />
          <Tab.Screen name='OrdersClientFav' component={OrdersClientFavComponent}
            options={({ route }) => ({
              tabBarButton: () => null,
              tabBarStyle: { display: 'none' }
            })}
          />
          <Tab.Screen name='EditingPage' component={EditingPageComponent}
            options={({ route }) => ({
              tabBarButton: () => null,
              tabBarStyle: { display: 'none' }
            })}
