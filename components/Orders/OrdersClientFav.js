...
export default class OrdersClientFavComponent extends Component {
    constructor(props) {
        super(props)
    }

    goToOrdersClientPage = () => {
        this.props.navigation.navigate('OrdersClient')
    }
    goToEditingPage = () => {
        this.props.navigation.navigate('EditingPage')
    }
        ...
        return (
            <SafeAreaView
                ...
                <View style={styles.header}>
                    ...
                    >
                        <TouchableOpacity
                            onPress={() => { this.goToOrdersClientPage() }}
                        >
